...
### 📁 对话历史管理
- **智能存储**：自动保存所有对话历史，支持本地存储和快速检索
- **便捷管理**：支持对话重命名、删除、快速切换等操作
- **一键清空**：提供安全的一键清空功能，二次确认防误操作
- **响应式侧边栏**：智能适配桌面和移动设备，流畅的展开收起动画
- **精美卡片设计**：优雅的对话卡片布局，支持长文本智能截断
...
### 🎆 核心功能增强
- ✨ **对话历史管理**：全新的对话历史功能，支持智能存储、便捷管理和一键清空
- 📱 **响应式侧边栏**：智能适配桌面和移动设备，流畅的展开收起动画
- 💬 **Chat 模式优化**：支持“简单聊天”模式，灵活切换研究和对话场景

### 🌍 本地化优化
- 🇺🇳 **全面汉化**：界面、交互、提示等完全中文化，适合中文用户
- 🖥️ **响应式设计**：完美适配桌面、平板、手机等多终端设备

### 🔧 技术优化
- ⚙️ **Settings 界面修复**：Tab 显示问题修复，用户体验提升
- 🔍 **SearXNG 一键集成**：自动安装和配置，无需手动部署
- 🔒 **一键 SSL 部署**：安全加密访问，简单易用

### 🎨 用户体验提升
- 🎭 **流畅动画**：所有交互都具有精美的过渡动画效果
- 📋 **智能卡片**：优雅的对话卡片设计，支持长文本智能截断
- 🛡️ **交互优化**：修复界面异常，提升操作流畅度
...
#### 📁 对话操作
- **创建新对话**：点击侧边栏的“+”按钮创建新的对话
- **切换对话**：在侧边栏中点击任意对话卡片即可切换
- **重命名对话**：点击对话卡片右上角的“⋮”按钮，选择“编辑”
- **删除对话**：在下拉菜单中选择“删除”

#### 🗑️ 批量管理
- **一键清空**：点击侧边栏头部的垃圾桶图标，可以清空所有对话历史
- **安全确认**：清空操作需要二次确认，防止误操作
- **智能禁用**：当没有对话历史时，清空按钮自动禁用

#### 📱 响应式体验
- **桌面端**：侧边栏固定在左侧，支持展开收起动画
- **移动端**：侧边栏以浮动层形式显示，不影响主内容区域
- **平滑动画**：所有交互都具有流畅的过渡动画效果
